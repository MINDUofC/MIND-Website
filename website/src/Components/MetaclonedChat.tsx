  ...
  return (
    <>
      <button
        type="button"
        onClick={openChat}
        className="fixed bottom-6 right-6 z-[100] flex h-14 w-14 items-center justify-center rounded-full transition-all duration-300 hover:scale-105 active:scale-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#85C7F2]"
        style={{
          backgroundColor: "#002960",
          color: "#85C7F2",
          boxShadow: "0 4px 14px 0 rgba(0, 41, 96, 0.35), 0 0 0 1px rgba(133, 199, 242, 0.15)",
        }}
      ...
      >
        <svg
          ...
          aria-hidden
        >
          <path d="M4.913 2.658c3.225-1.178 6.834-1.178 10.059 0 1.978.722 3.348 2.152 4.07 4.13.723 1.977.723 4.186 0 6.163-.722 1.978-2.092 3.408-4.07 4.13-3.225 1.178-6.834 1.178-10.059 0-1.978-.722-3.348-2.152-4.07-4.13-.723-1.977-.723-4.186 0-6.163.722-1.978 2.092-3.408 4.07-4.13Z" />
        </svg>
      </button>

      {isOpen && (
        <div
          className="chat-backdrop-enter fixed inset-0 z-[200] bg-black/40 backdrop-blur-[2px]"
