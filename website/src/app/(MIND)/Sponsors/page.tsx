...
export default function Sponsors() {
    return (
        ...
        <div className="bg-grey min-h-screen w-full bg-cover bg-center bg-no-repeat relative">
            ...
            <h2 className="font-extrabold text-7xl slide-in-left" style={{position: 'absolute', top: '45px', left: '50%', transform: 'translateX(-150%)', color: '#FFFFFF'}}>Our Sponsors</h2>
            <p className="font-bold text-6xl fade-in-second" style={{position: 'absolute', top: '200px', left: '50%', transform: 'translateX(-131%)', color: '#FFFFFF'}}>Innovate with us. <br /> Become a Sponsor</p>
