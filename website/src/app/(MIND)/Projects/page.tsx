...
export default function Projects() {
    return (
        ...
        <div className="bg-blue min-h-screen w-full bg-cover bg-center bg-no-repeat relative">
            ...
            <h2 className="font-extrabold text-7xl fade-in" style={{ position: 'absolute', top: '50px', left: '37%', color: '#85C7F2'}}>Our Projects</h2>
            <img src="/images/ARM.png" alt="Projects" className="absolute right-10 top-1/2 transform -translate-y-3/4 object-contain slide-in-right" style={{ top: '725px', right: '135px', width: '300px', height: 'auto' }} />
            <img src="/images/headset.png" alt="Projects" className="absolute right-10 top-1/2 transform -translate-y-3/4 object-contain slide-in-right" style={{ top: '365px', right: '150px', width: '265px', height: 'auto' }} />
            <p className="font-semibold text-3xl drop-shadow-lg slide-in-left" style={{position: 'absolute', top: '200px', left: '23%', transform: 'translateX(-50%)', color: '#85C7F2' }}>Our First Project: The BCI - NeuroDrive</p>

            <p className="font-light text-xl drop-shadow-lg slide-in-left" style={{position: 'absolute', top: '265px', left: '38%', transform: 'translateX(-49%)', color: '#85C7F2'}}>
            ...
            <hr className="w-3/5 border-t-2 mx-auto my-4" style={{position: 'absolute', top: '450px', left: '37%', transform: 'translateX(-50%)', color: '#85C7F2'}} />

            <p className="font-semibold text-3xl drop-shadow-lg slide-in-left" style={{position: 'absolute', top: '515px', left: '13%', transform: 'translateX(-54%)', color: '#85C7F2' }}>The Exo Arm</p>

            <p className="font-light text-xl drop-shadow-lg slide-in-left" style={{position: 'absolute', top: '570px', left: '38%', transform: 'translateX(-49%)', color: '#85C7F2'}}>
