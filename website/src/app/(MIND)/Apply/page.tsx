    ...
    return (
        <div className={`${montserrat.className}`}>
            ...
            <div className="apply-box">
                ...
                <p className="font-regular text-3xl drop-shadow-lg fade-in-second sub-apply">We hire year round and recieve applications often, click the link below to check our LinkTree for any open hiring positions!</p>
                <div className="fade-in-second apply-button">
                    <a href='https://linktr.ee/mind.uofc'>
