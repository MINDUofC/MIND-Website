...
export default function Contact() {
    return (
        ...
        <div className="bg-grey-blue min-h-screen w-full bg-cover bg-center bg-no-repeat relative">
            ...
            <p className="font-regular text-3xl fade-in" style={{ position: 'absolute', top: '310px', left: '72%', transform: 'translateX(-185%)', color: '#002960'}}>For any questions or inquiries, feel free to contact us through any one of our socials, linked below!</p>
            <a href='https://www.instagram.com/mind.uofc/' style={{ display: 'inline-block', padding: 0, margin: 0 }}>
            <img src="/images/insta.png" alt="Instagram" style={{ position: 'absolute', top: '435px', left: '60%', transform: 'translateX(-950%)', width: '75px', height: '75px' }} />
            </a>
            <a href='https://www.linkedin.com/company/mind-uofc/' style={{ display: 'inline-block', padding: 0, margin: 0 }}>
            <img src="/images/linkedin.png" alt="Linkedin" style={{ position: 'absolute', top: '435px', left: '60%', transform: 'translateX(-750%)', width: '75px', height: '75px' }} />
            </a>
            <a href='uofc.mind@gmail.com' style={{ display: 'inline-block', padding: 0, margin: 0 }}>
            <img src="/images/gmail.png" alt="Gmail" style={{ position: 'absolute', top: '435px', left: '60%', transform: 'translateX(-550%)', width: '75px', height: '75px' }} />
            </a>
